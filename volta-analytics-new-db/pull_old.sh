...
# Finance / Profit Margins, Part 1 (Site Price vs Purchase Price, August only) needs no dedicated dump --
# build_sales.js reads it straight off Sales Monthly's own August aggregate (old_sales_grouped.tsv above).
# Part 2 (Installment Total vs Site Price) moved to September/VoltaStoreDB on 2026-09-23 -- see pull_new.sh.
