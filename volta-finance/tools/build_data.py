...
CF_CAT_CODES = {
    ...
    # 2026-09-21, per the user ("fix according to the Excel"): the finance team's own Salary tag (hidden Oris sheet) covers
    # the WHOLE payroll cash-out, not just the 3 1 32 employee accounts: '3 1 30' salary payable (Jan-Feb salaries were paid
    # through it), '3 3 70' social tax, '3 1 10 2267' staff insurance and the unified tax account '3 3 20 1' (payroll taxes;
    # the finance model splits out VAT paid Jan-Apr by hand, which no account rule can reproduce - see avNoteCF).
    'salary_other': [r[0] for r in con.execute("SELECT DISTINCT COUNT FROM ACC_NAME WHERE COUNT LIKE '3 1 32 %'")] + ['3 1 30', '3 1 10 2267', '3 3 70', '3 3 20 1', '3 1 10 10293'],  # 10293 (S.G. Management): Excel tags it Salary 41.7k vs Cogs 5.0k
    # Excel tags 'Capex - office equipment' (row 59 "Salesman Office Equipment Capex"); 11793 is tagged Capex there (the newer file says Office Rent).
    'capex_office': ['3 1 10 8450', '3 1 10 11967', '3 1 10 11644', '3 1 10 11793'],
    ...
    # '8 2 50' (FX-difference expense) removed 2026-09-21: it is not office expense (the Excel tags those 1.9k as 'Ex Rate') - user-approved
    'office_exp': ['1 4 10 12186', '3 1 10 10100', '3 1 10 10242', '3 1 10 10505', '3 1 10 11350', '3 1 10 11674', '3 1 10 11835', '3 1 10 12185', '3 1 10 12485', '3 1 10 1278', '3 1 10 1459', '3 1 10 1477', '3 1 10 174', '3 1 10 2', '3 1 10 2767', '3 1 10 3', '3 1 10 3121', '3 1 10 3200', '3 1 10 3708', '3 1 10 3950', '3 1 10 4119', '3 1 10 4474', '3 1 10 4582', '3 1 10 4588', '3 1 10 4825', '3 1 10 4880', '3 1 10 4936', '3 1 10 5214', '3 1 10 5570', '3 1 10 6802', '3 1 10 6927', '3 1 10 6944', '3 1 10 7526', '3 1 10 7708', '3 1 10 7981', '3 1 10 7990', '3 1 10 7991', '3 1 10 8093', '3 1 10 8131', '3 1 10 8136', '3 1 10 8143', '3 1 10 8184', '3 1 10 8185', '3 1 10 8186', '3 1 10 8189', '3 1 10 8191', '3 1 10 8299', '3 1 10 8331', '3 1 10 8377', '3 1 10 8449', '3 1 10 8451', '3 1 10 90', '3 1 10 9343', '3 1 10 9432', '3 1 10 9532', '3 1 10 9568', '3 1 10 9790', '3 1 31 0040', '3 1 31 0046', '3 1 31 0092', '3 1 31 0095', '3 1 31 0096', '3 1 31 0097', '3 1 31 0104', '3 1 31 0106', '3 1 31 0108', '3 1 31 0171', '3 1 31 11721', '3 1 31 11969', '3 1 31 12044', '7 4 12', '7 4 90 3', '7 4 90 37', '8 1 50'],
    'dividend': ['3 4 20', '1 7 91 0004', '1 7 91 0011', '1 7 91 0012'],  # 1 7 91 = advance dividend paid to shareholders (newer file, Aug 2026)
...
# Accounts that only appear from Jul/Aug 2026 (after the Excel model's data), classified by the finance team's newer Mapping file
# (2026-09-21, no Excel evidence to contradict them): marketing service fee / transportation / cogs.
CF_CAT_CODES['marketing'] += ['3 1 10 12535', '3 1 10 12599', '3 1 10 12719', '3 1 31 12634']
CF_CAT_CODES['delivery'] += ['3 1 10 12533', '3 1 31 11881']
CF_CAT_CODES['cogs'] += ['3 1 10 12907']
